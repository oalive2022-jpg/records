...
-- 支援記録ノート（外部APIで連携する別システム）側のID紐付け
ALTER TABLE homes ADD COLUMN IF NOT EXISTS shien_home_id TEXT;
ALTER TABLE home_users ADD COLUMN IF NOT EXISTS shien_resident_id TEXT;
